(module
  ...
  (func $get_answer (param $input_len i32) (result i32)
    ...
    ;; Before program starts, set position 1 to 12 and position 2 to 2
    (i32.store (i32.add (local.get $ptr) (i32.const 4)) (i32.const 12))
    (i32.store (i32.add (local.get $ptr) (i32.const 8)) (i32.const 2))
      ...
      (loop $loop
        ...
        (if
          ...
          (then
            ...
            (call $die_if_oob (global.get $work_buf) (local.get $input_len) (local.get $r1))
            ...
            (call $die_if_oob (global.get $work_buf) (local.get $input_len) (local.get $r2))
            ...
            (call $die_if_oob (global.get $work_buf) (local.get $input_len) (local.get $ro))
        ...
        (call $die_if_oob (global.get $work_buf) (local.get $input_len) (local.get $ptr))
